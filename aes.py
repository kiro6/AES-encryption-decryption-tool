...
# uncomment this function to full test with your msg and key


st = time.thread_time()
full_test()
#full_test_pdf_encryption()
#full_test_pdf_decryption()
#full_test_jpg_encryption()
#full_test_jpg_decryption()
fi = time.thread_time()
print(fi-st)
